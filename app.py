...
# File desa → gapoktan
gapoktan_df = pd.read_excel("data1.xlsx")

# File kecamatan → desa
kec_desa_df = pd.read_csv("poktan_clean.csv")   # kolom: kecamatan, desa
...
kec_select = c1.selectbox("Pilih Kecamatan", list(data_hierarchy.keys()))
